...
$slr_id		= isset($_GET["slr_id"]) 		? $_GET["slr_id"] 		: '';
...
<form class="form-container" method="post">
  ...
  <table>	
  <tr><td><div class="form-title">Smart Link Rule 			: </div></td><td><input  class="form-field-edit" 				name='slr_id' 		value=<?php echo $slr_id; ?>  								  ></td></tr>
...
function apply()
{
	...
	else
	{
		...
		// console.log(id_list);
		 ...
		 var slr_id 		= document.getElementsByName("slr_id")[0].value
		...
		if (slr_id == "")
		{
			alert ("Please Select A Smart Link Rule");
			return
		}
		...
		$.post( "post_create_slr_list.php?slr_id="+slr_id+"&list_type_id="+list_type_id+"&behavior="+behavior,{id_list: id_list})
		  	.done(function( data ) {
				console.log(data)
